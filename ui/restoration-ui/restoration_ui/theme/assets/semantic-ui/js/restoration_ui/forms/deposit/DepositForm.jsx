...
// import {ConnectedVocabularySelectField} from './reducer'
...
// useEffect(() => {
//   fetch('https://0.0.0.0:5000/api/user/restoration/?q=&sort=newest&page=1&size=10')
//     .then((response) => response.json())
//     .then((data) => {
//       setPredefinedValue(data.predefinedValue);
//     })
//     .catch((error) => {
...
export const DepositForm = () => {
  ...
  const handleSelectChange = (field, selectedValue) => {
    setVocabularyValue(field, selectedValue);
  };

  const handleResetClick = (field) => {
    resetVocabularyValue(field);
  };
                  ...
                  <div className="vert-div predmety__form__div">
                    <div className="vert-div predmety__form__div">
                      <VocabularySelectField
                        ...
                        value={record.metadata?.restorationWork?.[0]?.restorationMethods}
                        clearable
                        label={
                          <FieldLabel
                            htmlFor={
