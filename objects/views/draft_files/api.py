...
def create_api_blueprint(app):
    """Create ObjectsFileDraft blueprint."""
    blueprint = app.extensions["objects"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_objects_file_draft") and callable(v)
    ]
    for func in funcs:
