...
class ObjectsSearchOptions(SearchOptions):
    ...
    facet_groups = {
        "default": {
            ...
            "metadata_restorationObject_colors": (
                facets.metadata_restorationObject_colors
            ),
            ...
            "metadata_restorationObject_fabricationTechnologies": (
                facets.metadata_restorationObject_fabricationTechnologies
            ),
            ...
            "metadata_restorationObject_materialType": (
                facets.metadata_restorationObject_materialType
            ),
            "metadata_restorationObject_restorationRequestor": (
                facets.metadata_restorationObject_restorationRequestor
            ),
            "metadata_restorationObject_secondaryMaterialTypes": (
                facets.metadata_restorationObject_secondaryMaterialTypes
            ),
    ...
    facets = {
        ...
        "metadata_restorationWork_supervisors": (
            facets.metadata_restorationWork_supervisors
        ),
