...
def create_api_blueprint(app):
    """Create RestorationFile blueprint."""
    blueprint = app.extensions["restoration"].resource_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_restoration_file") and callable(v)
    ]
    for func in funcs:
