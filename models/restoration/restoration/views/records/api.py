...
def create_api_blueprint(app):
    """Create RestorationRecord blueprint."""
    blueprint = app.extensions["restoration"].resource_records.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_restoration") and callable(v)
    ]
    for func in funcs:
...
def init_addons_restoration_published_service(state):
    """Init app."""
    app = state.app
    ext = app.extensions["restoration"]
