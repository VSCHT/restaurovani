...
def create_api_blueprint(app):
    """Create RestorationFileDraft blueprint."""
    blueprint = app.extensions["restoration"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_restoration_file_draft") and callable(v)
    ]
    for func in funcs:
